...
router.get('/bucket', storageController.listBuckets);
router.delete('/bucket/:bucketName', storageController.deleteBucket);

// Object Bulk Operations
router.post('/object/move', storageController.moveFile);
router.post('/object/copy', storageController.copyFile);
router.get('/object/list/:bucketName', storageController.listFiles);
router.post('/object/sign/:bucketName/*path', storageController.generateSignedUrl);

// Standard File CRUD
router.post('/object/:bucketName/*path', storageMiddleware.uploadSingle, storageController.uploadFile);
router.get('/object/:bucketName/*path', storageController.downloadFile);
router.delete('/object/:bucketName/*path', storageController.deleteFile);
